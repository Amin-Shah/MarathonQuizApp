var questions = [
    ["Which property tells how many rows a cell should span ?",'colspan=n' ,'Both rowspan=n and colspan=n','rowspan=n','C'],
    ['To create a list using lowercase letters use ?','<ol "a"> ','<ol letter="a">','<ol type="a">','C'],
    ['To start a numbered list with regular numerals use ?' ,'<ol type="a">','<ol type="1">',' <ol type="I">','B'],
    ['Colors in plain HTML can be specified using ?','Meta tags','Images','Hexadecimal Colors','C'],
    ['Is it possible to link within the current page ?','No','Only in framesets','Yes','C']
